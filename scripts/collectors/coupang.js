 ...
 *   Authorization: CEA algorithm=HmacSHA256, access-key=..., signed-date=YYYYMMDDTHHMMSSZ,
 ...
 *   - createdAtFrom / createdAtTo (yyyy-MM-ddTHH:mm:ss, KST)
 *   - status=ACCEPT(결제완료) 등으로 필터
 *   - 응답의 orderItems[].orderPrice 합계
 *
